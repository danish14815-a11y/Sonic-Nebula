...
export const SongCard = ({ track, trackList = [] }) => {
  ...
  const artists = track.artists?.primary?.map(a => a.name).join(', ') || track.artist || '';
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-10 flex flex-col justify-end p-3">
        ...
        <p className="text-sm font-medium text-white truncate" dangerouslySetInnerHTML={{ __html: track.name || 'Unknown' }} />
...
export const AlbumCard = ({ album }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-10 flex flex-col justify-end p-3">
        <p className="text-sm font-medium text-white truncate" dangerouslySetInnerHTML={{ __html: album.name || 'Unknown' }} />
...
export const ArtistCard = ({ artist }) => {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm font-medium text-white text-center truncate w-full" dangerouslySetInnerHTML={{ __html: artist.name || 'Unknown' }} />
    </Link>
  );
};
...
export const PlaylistCard = ({ playlist }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-10 flex flex-col justify-end p-3">
        <p className="text-sm font-medium text-white truncate" dangerouslySetInnerHTML={{ __html: playlist.name || 'Unknown' }} />
